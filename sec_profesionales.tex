...
\cventry{jul 2022-\actual}
	...
	\begin{description}
		...
		\item[Desarrollo de Productos:] Liderar el desarrollo de productos innovadores que aprovechen los indicadores generados, como la creación de aplicaciones amigables para el usuario y plataformas en línea para brindar a las partes interesadas acceso a datos relevantes y accionables. Diseño de un microservicio en FastAPI que integra TaskJuggler para la planificación de proyectos, comparando escenarios base y escenarios asistidos por IA dentro de un módulo de gestión de proyectos en Odoo.
...
\cventry{2015-2026}
	...
	{Buenos Aires, Argentina}
	{}
	{Diseño y desarrollo de punta a punta de una plataforma de información geoestadística, evolucionada a lo largo de una década en tres generaciones (EULAC 2015 $\to$ GeoEcon 2018 $\to$ GeaIQ 2025). Responsable técnico principal durante la primera etapa del desarrollo; luego se incorporaron perfiles de diseño y frontend al equipo.
	\begin{description}
	...
	\item[Evolución del Producto:] Iteración del producto en tres generaciones, desde una plataforma de datos inicial (EULAC) pasando por GeoEcon hasta una versión con integración de IA generativa (GeaIQ), discontinuada en 2026 para redirigir el foco a oportunidades financiadas con equipo.
	\end{description}}
